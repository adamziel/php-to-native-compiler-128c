...
- Recorded php-src runnable subset: `tests/basic/001.phpt`, `tests/output/ob_001.phpt`, and `tests/basic/gh15905.phpt` from the pinned PHP-8.3 tree execute through `phpc phpt-run` and currently report `pass` under `phpc_run`.
