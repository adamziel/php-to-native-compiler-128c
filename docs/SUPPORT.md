...
- Recorded php-src runnable subset: `tests/basic/001.phpt` from the pinned PHP-8.3 tree executes through `phpc phpt-run` and currently reports `pass` under `phpc_run`.
