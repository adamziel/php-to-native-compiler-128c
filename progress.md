...
Last refreshed: 2026-05-26T03:27:33Z

## Current State

- Repository: `adamziel/php-to-native-compiler-128c`
- Branch: `main`
- Report base HEAD: `184fabc`
- Dirty entries: `0`
...
- Latest launcher event: `2026-05-26T03:24:57Z launch: waiting 480s before starting Codex session 8/100.`
- Interactive Codex panes: `7`
...
| M5 PHP core .phpt harness | PHP-8.3 branch, 19,346 `.phpt` files | 5% | PHP-8.3 inventory pinned; minimal FILE/FILEEOF exact-EXPECT/EXPECTF phpc runner integrated |
